...
Proprietary web-interfaces are commonly neither tailored to the display of Arabic material nor themselves available in Arabic [C.f. @Mansour+2020; @Wrisley+2019; @Wrisley+2016]. Downloading content in order to circumvent  ill-suited interfaces is limited to individually identifiable users. Bulk download frequently violates terms of use and most vendors try to prevent this on the technical level.
...
[^17]: Our version of the TEI Boilerplate is openly available at <https://github.com/OpenArabicPE/tei-boilerplate-arabic-editions>.
